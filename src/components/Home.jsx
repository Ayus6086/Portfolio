...
import ayushImage from '../assets/aayush.jpg';
import cvFile from '../assets/AyushAnandGeneralCV.pdf';
...
const Home = () => {
  ...
  const roles = ['Software Developer', 'Fullstack Developer', 'UI/UX Designer'];

  const handleDownloadCV = () => {
    const link = document.createElement('a');
    link.href = cvFile;
    link.download = 'AyushAnand_CV.pdf';
    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-gray-900 text-white">
      <div className="w-[90%] mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            <h1 className="text-6xl md:text-7xl font-bold mb-4">Hi, I am <span className="text-purple-400">Ayush Anand</span></h1>
